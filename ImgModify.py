...
def takeImg(filename):
  ...
  inImg  = cv2.imread(os.path.dirname(__file__) + '/Image/' + filename)
  return inImg
...
Img = takeImg('Tho4.jpeg')
ImgC = convert_img_size(Img, 50, 50)
cv2.imwrite(os.path.dirname(__file__)+'/Tho5.jpeg', ImgC)